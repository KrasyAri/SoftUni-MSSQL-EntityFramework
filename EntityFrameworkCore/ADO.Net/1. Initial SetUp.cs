...
namespace AdoNet
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            using (var connection = new SqlConnection(sqlConnectionString))
            {
                ...
                // -- CREATE DATABASE
                    ...
                    //ExecuteNonQuery(connection, createDatabaseString);

                // --CREATE TABLES
                    //var createTableStatement = GetTableStatement();
                ...
                // --INSERT DATA
                    ...
                    //var insertDataStatement = GetInsertDataStatement();
                    //
                    //foreach (var query in insertDataStatement)
                    //{
                    //    ExecuteNonQuery(connection, query);
                    //}
        ...
        private static string[] GetTableStatement()
        {
